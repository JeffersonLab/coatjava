...
# run reconstruction:
rm -f out_${stub}.hipo
#../../coatjava/bin/recon-util -l FINE -i ${input_dir}/${stub}.hipo -o out_${stub}.hipo -c 2 -- -Xmx25000m -Xms3000m 
../../coatjava/bin/recon-mutil -t 12 -l FINE -i ${input_dir}/${stub}.hipo -o out_${stub}.hipo -c 2 -- -Xmx25000m -Xms3000m 
