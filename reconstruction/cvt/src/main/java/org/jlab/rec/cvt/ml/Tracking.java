 ...
 * @author ziegler
 */
public class Tracking extends CVTInitializer {
    ...
    public void processData(DataEvent event) {
        ...
        List<Cluster> aicls = aicr.getMLClusters(event, swimmer, getAistatus());
        ...
        banks.add(RecoBankWriter.fillBMTHitBank(event, aicr.getBMTHits(), this.getBmtHitBank()));
