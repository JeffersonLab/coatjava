 ...
 *
 */
public class CVTTrackSelectorEngine extends ReconstructionEngine {
    ...
    public CVTTrackSelectorEngine(String name) {
        super(name, "ziegler", "6.0");
    }

    public CVTTrackSelectorEngine() {
    ...
    public void registerBanks() {
        ...
        this.setTrackBank("CVT" + prefix + "::STracks");
