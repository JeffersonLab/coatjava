...
public class URWellCluster {
    ...
    */
    ...
    public String toString() {
        String str = "Cluster: Index " + this.id() 
                              + ", Layer " + this.layer()
                              + ", Seed "  + this.strip()
                              + ", Size "  + this.size()
                              + ", originLocX "  + String.format("%.4f", this.getLineLocal().origin().x())
                              + ", originLocY "  + String.format("%.4f", this.getLineLocal().origin().y())
                              + ", originLocZ "  + String.format("%.4f", this.getLineLocal().origin().z())
                              + ", endLocX "  + String.format("%.4f", this.getLineLocal().end().x())
                              + ", endLocY "  + String.format("%.4f", this.getLineLocal().end().y())
                              + ", endLocZ "  + String.format("%.4f", this.getLineLocal().end().z());                
        return str;
    }    
}
