...
public class RICHEvent {
    ...
    private ArrayList<RICHHit>               hits  = new ArrayList<>();
    private ArrayList<DetectorResponse>   resclus  = new ArrayList<>();
    private ArrayList<DetectorResponse>   reshits  = new ArrayList<>();
    private ArrayList<DetectorResponse>   matches  = new ArrayList<>();
    private ArrayList<RICHParticle> hadrons = new ArrayList<>();
    private ArrayList<RICHParticle> photons = new ArrayList<>();
