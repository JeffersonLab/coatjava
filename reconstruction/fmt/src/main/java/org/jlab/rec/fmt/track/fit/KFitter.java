...
public class KFitter {
    ...
    Track track = null;
    private List<URWellCluster> clusters;
    ...
    public KFitter(List<URWellCluster> clusters, int sector, double xVtx, double yVtx, double zVtx,
    ...
    private void init(List<URWellCluster> clusters, int sector, double xVtx, double yVtx, double zVtx,
    ...
    private void filter(int k) {
        if (sv.trackTraj.get(k) != null && sv.trackCov.get(k).covMat != null && k < sv.Z.length ) {
            ...
            double[] H = mv.HURWell(sv.trackTraj.get(k),sv);
            ...
            double res = mv.dhURWell(sv.trackTraj.get(k));                      
