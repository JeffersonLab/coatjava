...
level3 = list(dst)
level3.extend(["DC::tdc", "ECAL::adc", "HTCC::adc", "FTOF::tdc", "FTOF::adc", "TimeBasedTrkg::TBClusters", "TimeBasedTrkg::TBTracks", "HitBasedTrkg::HBClusters", "HitBasedTrkg::HBTracks", "ECAL::clusters"])
