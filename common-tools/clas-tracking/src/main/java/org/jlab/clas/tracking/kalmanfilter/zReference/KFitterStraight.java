 ...
 * @author Tongtong Cao
 */
public class KFitterStraight extends AKFitter {
    ...
    private AMeasVecs.MeasVec skipMeas;

    public KFitterStraight(boolean filter, int iterations, int dir, Swim swim, double Z[], Libr mo) {
