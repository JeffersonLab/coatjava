...
public class IndexedList<T> {
    ...
    /**
     * Checks whether an item exists for the specified hash.
     *
     * @param hash the hash to look up
     * @return true if an item exists at the hash; false otherwise
     */
     ...
     * @return the item at the hash, null if not found
     */
