...
public class GaussJordan {
     ...
     * 
     * 
     * Linear equation solution by Gauss-Jordan elimination. The input matrix is
     ...
     * 
     * 
     * Copyright (C) Numerical Recipes Software 1986-2007 Java translation
	...
	for (i = 0; i < n; i++) {
	     ...
	     * the .i C 1/th pivot element, is the .i C 1/th column that is
	     * reduced, while indxr[i] is the row in which that pivot element
	     * was originally located. If indxr[i] ¤ indxc[i], there is an
	    ...
	    indxc[i] = icol;
	    if (a[icol][icol] == 0.0)
		throw new IllegalArgumentException("gaussj: Singular Matrix");
	...
	double[][] b = new double[a.length][0]; // Dummy vector with zero
						// columns.
	gaussj(a, b);
    }
}
