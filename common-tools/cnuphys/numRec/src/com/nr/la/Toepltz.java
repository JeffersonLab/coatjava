...
public class Toepltz {
     ...
     * 
     * The Toeplitz matrix need not be symmetric. y[0..n-1] and r[0..2*n-2] are
     * input arrays; x[0..n-1] is the output array.
     * 
     * @param r
     * @param x
     * @param y
     */
    public static void toeplz(final double[] r, final double[] x,
	    final double[] y) {
