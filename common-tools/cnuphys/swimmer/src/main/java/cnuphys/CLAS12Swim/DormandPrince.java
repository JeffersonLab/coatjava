...
public class DormandPrince {
	...
	public static void solve(ODE ode, double[] y0, double t0, double t1, double h, double tolerance, double minH,
		...
		final double[][] a = { {}, { 1.0 / 5 }, { 3.0 / 40, 9.0 / 40 }, { 44.0 / 45, -56.0 / 15, 32.0 / 9 },
				{ 19372.0 / 6561, -25360.0 / 2187, 64448.0 / 6561, -212.0 / 729 },
				{ 9017.0 / 3168, -355.0 / 33, 46732.0 / 5247, 49.0 / 176, -5103.0 / 18656 },
				{ 35.0 / 384, 0, 500.0 / 1113, 125.0 / 192, -2187.0 / 6784, 11.0 / 84 } };
		final double[] b = { 35.0 / 384, 0, 500.0 / 1113, 125.0 / 192, -2187.0 / 6784, 11.0 / 84, 0 };
		final double[] bStar = { 5179.0 / 57600, 0, 7571.0 / 16695, 393.0 / 640, -92097.0 / 339200, 187.0 / 2100,
				1.0 / 40 };
		...
		while (t < t1) {
			...
			while (!acceptStep) {
				...
				k7 = ode.getDerivatives(t + c[6] * h,
						addVectors(y, scalarMultiply(k1, a[6][0] * h), scalarMultiply(k2, a[6][1] * h),
								scalarMultiply(k3, a[6][2] * h), scalarMultiply(k4, a[6][3] * h),
								scalarMultiply(k5, a[6][4] * h), scalarMultiply(k6, a[6][5] * h)));
				...
				for (int i = 0; i < n; i++) {
					yTemp[i] += h * (b[0] * k1[i] + b[1] * k2[i] + b[2] * k3[i] + b[3] * k4[i] + b[4] * k5[i]
							+ b[5] * k6[i] + b[6] * k7[i]);
					yTempStar[i] += h * (bStar[0] * k1[i] + bStar[1] * k2[i] + bStar[2] * k3[i] + bStar[3] * k4[i]
							+ bStar[4] * k5[i] + bStar[5] * k6[i] + bStar[6] * k7[i]);
