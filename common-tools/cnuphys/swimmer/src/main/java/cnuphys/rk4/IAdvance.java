...
public interface IAdvance {
	 ...
	 * @param deriv
	 *            the function (interface) that can compute the derivatives.
	 *            That is where the problem specificity resides (input).
	 * @param yout
	 *            where the state vector at the next step will be stored
	 *            (output)
	 * @param error
