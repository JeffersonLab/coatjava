...
public class StandardSolenoidProbe extends SolenoidProbe {

	private Cell2D _cell;

	private StandardSolenoid _solenoid;
	...
	public StandardSolenoidProbe(StandardSolenoid field) {
		super(field);
		...
		_solenoid = (StandardSolenoid)MagneticFields.getInstance().getSolenoid();
