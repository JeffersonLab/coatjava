...
/**
 * Nonlinear least-squares fitter for scaled/shifted erf:
 *
 * <pre>
 ...
 */
public final class ErfFitter extends ALeastSquaresFitter {
    ...
    /** Analytic model + Jacobian for erf. */
    private static final class ErfModel implements MultivariateJacobianFunction {
    ...
    /** Bounds container for erf parameters. */
    ...
    static final class InitialGuess {
        ...
        public static double[] guess(double[] x, double[] y) {
            ...
            // For erf: transitions from low to high (or high to low)
    ...
    //------- descriptive string section -----------------
 	...
 	public String parameterName(int index) {
 		if (index < 0 || index >= getParameterCount()) {
 			throw new IllegalArgumentException("bad parameter index in erf fit: " + index);
 		}
 	...
 	private static void testErf() {
		...
		ErfFitter fitter = new ErfFitter();
